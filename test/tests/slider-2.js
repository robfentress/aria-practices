...
ariaTest('Right arrow increases slider value by 1', exampleFile, 'key-right-arrow', async (t) => {
  ...
  t.is(
    ...
    sliderVal.toString(),
    'After sending 1 arrow right key to the temp slider, "aria-valuenow": ' + sliderVal
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    sliderVal.toString(),
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMax,
    'After sending 52 arrow right key, the value of the temp slider should be: ' + ex.tempMax
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMax,
  ...
  const fanSlider = await t.context.session.findElement(By.css(ex.fanSelector));
  await fanSlider.sendKeys(Key.ARROW_RIGHT);

  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    ['1', ex.fanValues[1]],
    'After sending 1 arrow right key to the fan slider, aria-valuenow should be "1" and aria-value-text should be: ' + ex.fanValues[1]
  );
  ...
  t.deepEqual(
    ...
    'After sending 5 arrow right key to the fan slider, aria-valuenow should be "' + ex.fanMax + '" and aria-value-text should be: ' + ex.fanValues[parseInt(ex.fanMax)]
  );

  // Send 1 key to heat slider
  const heatSlider = await t.context.session.findElement(By.css(ex.heatSelector));
  await heatSlider.sendKeys(Key.ARROW_RIGHT);

  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    ['1', ex.heatValues[1]],
    'After sending 1 arrow right key to the heat slider, aria-valuenow should be "1" and aria-value-text should be: ' + ex.heatValues[1]
  );
  ...
  t.deepEqual(
    ...
    'After sending 5 arrow right key to the heat slider, aria-valuenow should be "' + ex.heatMax + '" and aria-value-text should be: ' + ex.heatValues[parseInt(ex.heatMax)]
  );
});
...
ariaTest('up arrow increases slider value by 1', exampleFile, 'key-up-arrow', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    sliderVal.toString(),
    'After sending 1 arrow up key to the temp slider, "aria-valuenow": ' + sliderVal
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    sliderVal.toString(),
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMax,
    'After sending 52 arrow up key, the value of the temp slider should be: ' + ex.tempMax
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMax,
  ...
  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    ['1', ex.fanValues[1]],
    'After sending 1 arrow up key to the fan slider, aria-valuenow should be "1" and aria-value-text should be: ' + ex.fanValues[1]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    [ex.fanMax, ex.fanValues[parseInt(ex.fanMax)]],
    'After sending 6 arrow up key to the fan slider, aria-valuenow should be "' + ex.fanMax + '" and aria-value-text should be: ' + ex.fanValues[parseInt(ex.fanMax)]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    ['1', ex.heatValues[1]],
    'After sending 1 arrow up key to the heat slider, aria-valuenow should be "1" and aria-value-text should be: ' + ex.heatValues[1]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    [ex.heatMax, ex.heatValues[parseInt(ex.heatMax)]],
    'After sending 6 arrow up key to the heat slider, aria-valuenow should be "' + ex.heatMax + '" and aria-value-text should be: ' + ex.heatValues[parseInt(ex.heatMax)]
  );
});
...
ariaTest('page up increases slider value by 10', exampleFile, 'key-page-up', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    sliderVal.toString(),
    'After sending 1 page up key to the temp slider, the value of the temp slider should be: ' + sliderVal
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    sliderVal.toString(),
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMax,
    'After sending 5 page up key, the value of the temp slider should be: ' + ex.tempMax
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMax,
...
ariaTest('key end set slider at max value', exampleFile, 'key-end', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMax,
    'After sending key END, the value of the temp slider should be: ' + ex.tempMax
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMax,
  ...
  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    [ex.fanMax, ex.fanValues[parseInt(ex.fanMax)]],
    'After sending key end to the heat slider, aria-valuenow should be "' + ex.fanMax + '" and aria-value-text should be: ' + ex.fanValues[parseInt(ex.fanMax)]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    [ex.heatMax, ex.heatValues[parseInt(ex.heatMax)]],
    'After sending key end to the heat slider, aria-valuenow should be "' + ex.heatMax + '" and aria-value-text should be: ' + ex.heatValues[parseInt(ex.heatMax)]
  );
});
...
ariaTest('left arrow decreases slider value by 1', exampleFile, 'key-left-arrow', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    tempVal.toString(),
    'After sending 1 arrow left key, the value of the temp slider should be: ' + tempVal
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    tempVal.toString(),
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMin.toString(),
    'After sending 53 arrow left key to the temp slider, "aria-valuenow": ' + ex.tempMin
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMin.toString(),
  ...
  t.deepEqual(
    ...
    'After sending 1 arrow left key to the fan slider, aria-valuenow should be "' + fanVal + '" and aria-value-text should be: ' + ex.fanValues[fanVal]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    ['0', ex.fanValues[0]],
    'After sending 6 arrow left key to the fan slider, aria-valuenow should be "0" and aria-value-text should be: ' + ex.fanValues[0]
  );
  ...
  t.deepEqual(
    ...
    'After sending 1 arrow left key to the heat slider, aria-valuenow should be "' + heatVal + '" and aria-value-text should be: ' + ex.heatValues[heatVal]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    ['0', ex.heatValues[0]],
    'After sending 6 arrow left key to the heat slider, aria-valuenow should be "0" and aria-value-text should be: ' + ex.heatValues[0]
  );
});
...
ariaTest('down arrow decreases slider value by 1', exampleFile, 'key-down-arrow', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    tempVal.toString(),
    'After sending 1 arrow down key, the value of the temp slider should be: ' + tempVal
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    tempVal.toString(),
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMin.toString(),
    'After sending 53 arrow down key to the temp slider, "aria-valuenow": ' + ex.tempMin
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMin.toString(),
  ...
  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    [fanVal.toString(), ex.fanValues[fanVal]],
    'After sending 1 arrow down key to the fan slider, aria-valuenow should be "' + fanVal + '" and aria-value-text should be: ' + ex.fanValues[fanVal]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.fanSelector),
    ['0', ex.fanValues[0]],
    'After sending 6 arrow down key to the fan slider, aria-valuenow should be "0" and aria-value-text should be: ' + ex.fanValues[0]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    [heatVal.toString(), ex.heatValues[heatVal]],
    'After sending 1 arrow down key to the heat slider, aria-valuenow should be "' + heatVal + '" and aria-value-text should be: ' + ex.heatValues[heatVal]
  );
  ...
  t.deepEqual(
    await getValueAndText(t, ex.heatSelector),
    ['0', ex.heatValues[0]],
    'After sending 6 arrow downx key to the heat slider, aria-valuenow should be "0" and aria-value-text should be: ' + ex.heatValues[0]
  );
});
...
ariaTest('page down decreases slider value by 10', exampleFile, 'key-page-down', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    sliderVal.toString(),
    'After sending 1 page down key to the temp slider, the value of the temp slider should be: ' + sliderVal
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    sliderVal.toString(),
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMin,
    'After sending 5 page down key, the value of the temp slider should be: ' + ex.tempMin
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMin,
...
ariaTest('home set slider value to minimum', exampleFile, 'key-home', async (t) => {
  ...
  t.is(
    await tempSlider.getAttribute('aria-valuenow'),
    ex.tempMin,
    'After sending key HOME, the value of the temp slider should be: ' + ex.tempMin
  );
  t.is(
    await t.context.session.findElement(By.css(ex.pageTempSelector)).getText(),
    ex.tempMin,
  ...
  t.deepEqual(
    ...
    'After sending key home to the heat slider, aria-valuenow should be "' + ex.fanMin + '" and aria-value-text should be: ' + ex.fanValues[parseInt(ex.fanMin)]
  );
  ...
  t.deepEqual(
    ...
    'After sending key home to the heat slider, aria-valuenow should be "' + ex.heatMin + '" and aria-value-text should be: ' + ex.heatValues[parseInt(ex.heatMin)]
  );
